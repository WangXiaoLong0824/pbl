...
public interface HuiYuanMapper {
    ...
    @Insert("insert into user(user_name,user_sex,user_phone,user_email,create_time,user_jifen,level_id,user_status) values(#{userName},#{userSex},#{userPhone},#{userEmail},#{createTime},#{userJiFen},#{levelId},#{userStatus})")
